...
export function RoomProvider({children}) {
    ...
    useEffect(() => {
        const handleVotesUpdate = (data) => setRoom(prev => prev ? ({
            ...prev,
            votes: data.votes,
            showVotes: data.showVotes,
            isVoting: data.isVoting,
            showFireworks: data.showFireworks
        }) : prev);
    ...
    useEffect(() => {
        const handleViewerUpdate = (data) => setRoom(prev => prev ? ({
            ...prev,
    ...
    useEffect(() => {
        const handleTicketUpdate = (data) => setRoom(prev => prev ? ({
            ...prev,
            currentTicket: data,
            showVotes: false,
            votes: {},
