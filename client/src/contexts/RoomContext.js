...
export function RoomProvider({children}) {
  ...
  useEffect(() => {
    const handleVotesUpdate = (data) => setRoom(prev => prev ? ({ ...prev, votes: data.votes, showVotes: data.showVotes, isVoting: data.isVoting, showFireworks: data.showFireworks }) : prev);
